...
from . import net
from . import util
from .request_cookie import RequestCookie
...
def get_public_key(cookie, tokens):
    ...
    """
    url = "".join([
        net.kPassportBase, "v2/getpublickey",
        "?token=", tokens["token"],
...
def get_bdstoken(cookie):
    ...
    if req:
        return _parse_bdstoken(req.data.decode())
    else:
        return None
